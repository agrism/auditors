    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Companies list in system <a href="{{ url(route('admin.companies.create'))}}">
                        ...
                        @foreach($companies as $company)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url(route('admin.companies.show',  $company->id))}}">
                                        <div class="btn btn-success btn-xs fa-info fa"></div>
                                    </a>
