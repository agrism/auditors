<!-- Bootstrap Core CSS -->
<link rel="stylesheet"
      href="{{ URL::asset('build/admin-assets/sb-admin-2/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
...
<!-- Custom CSS -->
<link rel="stylesheet" href="{{ URL::asset('build/admin-assets/sb-admin-2/dist/css/sb-admin-2.css') }}">

<!-- Morris Charts CSS -->
<link rel="stylesheet" href="{{ URL::asset('build/admin-assets/sb-admin-2/bower_components/morrisjs/morris.css') }}">
