        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="{{ \Request::route()->getName() == 'admin.home' ? 'active' : null }}"><a
                            href="{{ url(route('admin.home')) }}">{{_('Companies')}}</a></li>
                <li class="{{ \Request::route()->getName() == 'admin.users.index' ? 'active' : null }}"><a
                            href="{{ url(route('admin.users.index')) }}">{{_('Users')}}</a></li>
                ...
                >
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="true">{{_('Roles')}} <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li class="{{ \Request::route()->getName() == 'admin.roles.index' ? 'active' : null }}"><a
                                    href="{{ url(route('admin.roles.index')) }}">{{_('Roles')}}</a></li>
                        <li class="{{ \Request::route()->getName() == 'admin.permissions.index' ? 'active' : null }}"><a
                                    href="{{ url(route('admin.permissions.index')) }}">{{_('Permissions')}}</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="{{ \Request::route()->getName() == 'client.index' ? 'active' : null }}"><a
