        ...
        <div class="card card-modern shadow-sm border-0 my-3">
            <div class="card-header bg-white border-bottom py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                        <h5 class="mb-0 fw-bold">{{ __('Pievienot jaunu partneri') }}</h5>
                        <span class="small text-muted">{{ __('Ievadiet partnera, klienta vai piegādātāja datus') }}</span>
                    </div>
                </div>

                <a href="{{ route('client.partners.index') }}" class="btn btn-modern btn-modern-secondary btn-sm">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-modern btn-modern-primary btn-sm">
                        <i class="fa-solid fa-check me-1"></i> {{ __('Izveidot partneri') }}
                    </button>
                </div>
                {!! Form::close() !!}
            </div>
