				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="{{ url(route('client.companies.show', $company->id)) }}">{{ $company->id}}</a></td>
							<td><a href="{{ url(route('client.companies.show', $company->id)) }}">{{ $company->title}}</a></td>
							<td><a href="{{ url(route('client.companies.show', $company->id)) }}">{{ $company->registration_number}}</a></td>
