...
{{--        {{$selectedPartnerId}}--}}
            <div>
{{--                <div style="width: 300px" id="partner-select" wire:ignore></div>--}}
                <div style="width: 300px" id="partner-select"></div>
            </div>
...
{{--                            <a style="display: block; float: right" href="https://www.firmas.lv/results?srch={{$selectedPartnerVatNo}}&exact=" target="_blank">Pārbaudīt firmas.lv</a>--}}
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('select_updated', () => {



            console.log('UUU1: {{$selectedPartnerId}}');
            console.log('UUU2: '+event.detail.newId);
            console.log(event);

            if(document.querySelector('#partner-select').val == event.detail.newId){
                return;
            }
            ...
            VirtualSelect.init({
              ...
              optionHeight: "25px",
              options: partners,
              selectedValue: event.detail.newId
            });
        });
        ...
        document.querySelector('#partner-select').addEventListener('change', function() {
          console.log('CC: '+this.value);
          @this.set('selectedPartnerId', this.value);
        });
    </script>
