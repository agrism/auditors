...
//    }
    ...
    public function index()
    {
        ...
        $user = User::with(['companies'=>function($q){
            $q->orderBy('title', 'asc');
        }])->find(Auth::user()->id);
    ...
    public function edit($id)
    {
        ...
        $user = User::with(['companies'=>function($q) use ($id){
    ...
    public function update(Request $request, $id)
    {
        ...
        $vatNUmbersToDelete = CompanyVatNumber::whereNotIn('id', $updatedVatIds)->where('company_id', $companyId);
