...
class StructuralunitController extends Controller
{
	...
	public function index(int $companyId)
	{
		...
		return view(
			...
			compact('company', 'structuralunits')
		);
	}
	...
	public function create($companyId)
	{
		...
		return view(
			'admin.companies.structuralunits.create', compact('company')
		);
	}
	...
	{
		$structuralunit = Structuralunit::where('company_id', $companyId)->find(
			$id
		);
		$company = Company::find($companyId);

		return view(
			'admin.companies.structuralunits.edit',
			compact('structuralunit', 'company')
		);
	...
	{
		$structuralunit = Structuralunit::with('invoices')->where(
